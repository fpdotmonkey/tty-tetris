...
static inline int io_con_put_char (char ch)
{
  putchar (ch);
  return 1;
}
static inline int io_con_put_str (char const *str)
{
  auto size_t s = strlen (str);
  fwrite (str, s, 1, stdout);
  return (int) s;
}
static inline int io_con_vout (char const *fmt, va_list ap)
{
