...
static void
tetris_refresh(tetris_t* self);

/* -------------------------------------------------------------------------- */
static void
tetris_pause(tetris_t* self)
{
...
/* -------------------------------------------------------------------------- */
static void
tetris_key_handler(void* p, char const* seq, int code)
{
  UNUSED(seq);
...
/* -------------------------------------------------------------------------- */
void
tetris_init(tetris_t* self, int left, int top, int options)
{
...
static inline void
tetris_timer_handler(void* self)
{
  tetris_tick((tetris_t*)self);
}
