...
/* ------------------------------------------------------------------------ */
static void
field_cell_out(field_t* self, unsigned char e)
{
  if (!e) {
    con_uncol();
...
/* ------------------------------------------------------------------------ */
void
field_row_fill(field_t* self, unsigned int y, int value)
{
  if (y < self->height)
    memset(
      self->data + self->width * y, value, sizeof(*self->data) * self->width);
}

/* ------------------------------------------------------------------------ */
void
field_fill(field_t* self, int value)
{
...
/* ------------------------------------------------------------------------ */
void
field_row_move(field_t* self, unsigned int dst, unsigned int src)
{
  if (dst >= self->height || src >= self->height)
    return;

  memcpy(self->data + self->width * (unsigned)dst,
         self->data + self->width * (unsigned)src,
...
/* ------------------------------------------------------------------------ */
unsigned int
field_row_wiegh(field_t* self, int y)
{
  unsigned int c = 0;
...
/* ------------------------------------------------------------------------ */
int
field_row_is_empty(field_t* self, int y)
{
...
/* ------------------------------------------------------------------------ */
int
field_row_is_full(field_t* self, int y)
{
...
/* ------------------------------------------------------------------------ */
unsigned int
field_check_coords(field_t* self, unsigned int x, unsigned int y)
{
...
cell_offset(field_t* self, int x, int y)
{
...
/* ------------------------------------------------------------------------ */
void
field_set_cell(field_t* self, int x, int y, int value)
{
...
/* ------------------------------------------------------------------------ */
unsigned int
field_get_cell(field_t* self, int x, int y)
{
  if (field_check_coords(self, x, y))
...
/* ------------------------------------------------------------------------ */
int
field_check_detonations(field_t* self)
{
  int c = 0;
  for (unsigned int y = 0; y < self->height; ++y)
...
/* ------------------------------------------------------------------------ */
void
field_detonate(field_t* self, int phase)
{
  for (unsigned int y = 0; y < self->height; ++y)
